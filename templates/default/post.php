	  ...
	  if (e.keyCode == 9) {
		...
		if (currentFocus > -1) {
		  ...
		  if (x) {
			...
			document.getElementById("shell").value = x[currentFocus].innerText; 
			document.getElementById("myInput").value = x[currentFocus].innerText; 
		  }
		...
		//document.getElementById("shell").submit();
        if (currentFocus > -1) {
          /*and simulate a click on the "active" item:*/
